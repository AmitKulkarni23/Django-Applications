# Generated by Django 2.0.5 on 2018-05-09 23:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the genre for the book(Fiction, Biography, Non-Fiction)', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
